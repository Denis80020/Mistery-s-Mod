...
import net.mcreator.mistterysmod.procedures.FunsedrOnBlockRightClickedProcedure;
...
public class FunsedrBlock extends MistterysModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(FunsedrBlock.block, (int) (1)));
		}
		...
		public boolean onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand, BlockRayTraceResult hit) {
			...
			Direction direction = hit.getFace();
			{
				...
				FunsedrOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
			return true;
		}
	}
